...
export default function OwnerHome() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.role}>Role: Owner</Text>
      <Text style={styles.note}>Owner screens coming in the next phase.</Text>
...
const styles = StyleSheet.create({
  ...
  role: { fontSize: 16, color: '#4f6ef7', fontWeight: '600', marginBottom: 12 },
